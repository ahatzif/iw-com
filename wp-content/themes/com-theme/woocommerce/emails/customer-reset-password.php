...
<?php endif; ?>
<p>
	<a class="btn" href="<?php echo esc_url( add_query_arg( array( 'reset-password-key' => $reset_key, 'id' => $user_id ), home_url( '/' ) ) ); ?>"><?php // phpcs:ignore WordPress.Arrays.ArrayDeclarationSpacing.AssociativeArrayFound ?>
		<?php esc_html_e( 'Επαναφορά συνθηματικού', 'com-theme' ); ?>
	</a>
</p>
