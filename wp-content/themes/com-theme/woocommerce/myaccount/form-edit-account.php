...
<form class="woocommerce-EditAccountForm edit-account account-form" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?>>
    ...
    <section>
        <h3 class="mb-20 text-[1.2rem] font-bold uppercase tracking-[.12em] text-blue-soft"><?= esc_html__( 'Προσωπικά στοιχεία', 'com-theme' ) ?></h3>
        <div class="grid gap-x-20 sm:grid-cols-2">
            <p class="form-row">
                <label for="account_first_name"><?= esc_html__( 'Όνομα', 'com-theme' ) ?> <span class="required" aria-hidden="true">*</span></label>
            ...
            <p class="form-row">
                <label for="account_last_name"><?= esc_html__( 'Επώνυμο', 'com-theme' ) ?> <span class="required" aria-hidden="true">*</span></label>
            ...
            <p class="form-row sm:col-span-2">
                <label for="account_display_name"><?= esc_html__( 'Όνομα προβολής', 'com-theme' ) ?> <span class="required" aria-hidden="true">*</span></label>
                <input type="text" name="account_display_name" id="account_display_name" value="<?= esc_attr( $user->display_name ) ?>" aria-required="true">
                <span class="mt-8 block text-[1.1rem] leading-[1.4] text-blue/55"><?= esc_html__( 'Έτσι θα εμφανίζεται το όνομά σας στον λογαριασμό.', 'com-theme' ) ?></span>
            </p>
            <p class="form-row sm:col-span-2">
                <label for="account_email"><?= esc_html__( 'Διεύθυνση email', 'com-theme' ) ?> <span class="required" aria-hidden="true">*</span></label>
    ...
    <fieldset class="mt-45 border-t border-dashed border-blue/25 pt-35">
        <legend class="mb-20 text-[1.2rem] font-bold uppercase tracking-[.12em] text-blue-soft"><?= esc_html__( 'Αλλαγή κωδικού', 'com-theme' ) ?></legend>
        ...
        <div class="grid gap-x-20 sm:grid-cols-2">
            <p class="form-row sm:col-span-2">
                <label for="password_current"><?= esc_html__( 'Τρέχων κωδικός', 'com-theme' ) ?></label>
                <input type="password" name="password_current" id="password_current" autocomplete="current-password">
            </p>
            <p class="form-row">
                <label for="password_1"><?= esc_html__( 'Νέος κωδικός', 'com-theme' ) ?></label>
                <input type="password" name="password_1" id="password_1" autocomplete="new-password">
            </p>
            <p class="form-row">
                <label for="password_2"><?= esc_html__( 'Επιβεβαίωση νέου κωδικού', 'com-theme' ) ?></label>
